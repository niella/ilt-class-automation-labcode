...
## Create JSON Server Instance Type

#Added in return statement in task functions lines 248 and 361
#624 added name to create layout - had name hardcodes
#624 added taskSets to create layout - need to test what happens if not adding a taskSet(workflow) to layout
#Need to add workflow_id to any lines calling create_layout function 
